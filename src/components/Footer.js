        ...
        <footer className="footer mt-auto py-3" style={{ boxShadow: '0px -5px 15px rgba(0, 0, 0, 0.1)' }}>
            <Container>
                <Row className="justify-content-md-center">
                    <Col xs lg="1">
                        <a href="https://www.youtube.com/@smktibazma" target="_blank" rel="noopener noreferrer">
                    ...
                    <Col xs lg="1">
                        <a href="https://www.instagram.com/smktibazma/" target="_blank" rel="noopener noreferrer">
                    ...
                    <Col xs lg="1">
                        <a href="https://id.linkedin.com/company/smk-ti-bazma" target="_blank" rel="noopener noreferrer">
                ...
                <Row>
                    <Col className="text-center">
                        <p>This page created by <a href='https://www.instagram.com/vncnt_ru/' target="_blank" rel="noopener noreferrer">Vincent Rahadian Utama</a>.</p>
                    </Col>
                </Row>
            </Container>
        </footer>
